                ...
                if data.hex().startswith("120000"):
                    ...
                    if response:
                        ...
                        if inPuTMsG.strip() == "/debug":
                            ...
                            debug_msg = f"[FF0000]✅NAJMI FF EXPERIMENT BOT ONLINE! UID: {uid}"
...
[FFFFFF]          ⚡NAJMI FF EXPERIMENT❤️  
[FFFFFF]                   thank for support 
[FF0000]╠══════════╣
[FFD700]⚡ OWNER : [FFFFFF]NAJMI FF EXPERIMENT    
[FFD700]✨ Name on instagram : [FFFFFF]NAJMI FF EXPERIMENT❤️  
[FF0000]╚══════════╝
[FFD700]✨ Developer —͟͞͞ </>NAJMI FF EXPERIMENT  ⚡"""
                            else:
                                message = f"""[C][B][FF0000]╔══════════╗
[FFFFFF]✨ folow on Instagram   
[FFFFFF]          ⚡NAJMI FF EXPERIMENT❤️  
...
async def MaiiiinE():
    ...
    Uid , Pw = '4251660660','D944280DAC8B84D4548AD3ED0FD048C8106BF5155F2A6BA2E1E3FA97201DC420'
    ...
    print('')
    print(f" -NAJMI FF EXPERIMENT BOT STarTinG And OnLine on TarGet : {TarGeT} | BOT NAME : {acc_name}\n")
    print(f" - BoT sTaTus > GooD | OnLinE ! (:")    
    print(f" -NAJMI FF EXPERIMENT | Bot Uptime: {time.strftime('%H:%M:%S', time.gmtime(time.time() - bot_start_time))}")    
